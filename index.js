...
global.deku = new Object({
  ...
  BOTNAME,
  ADMINBOT,
  ENDPOINT: "https://deku-rest-api-3jvu.onrender.com", // join our group to be updated if this API is suspended
  ...
  async function (err, api) {
    ...
    if (global.deku.AUTOCOMMENT == true) {
      cron.schedule(
        "0 */1 * * *",
        async function () {
          const pID = "3934925256743742"; // post ID
          const rands = [
            "Hi",
            "Hello",
            "Hey",
    ...
    api.listenMqtt(async function (err, event) {
      ...
      if (logMessageType == "log:subscribe") {
        ...
        if (
          ...
          const first = `🔴🟠🟡 𝙱𝙾𝚃 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙸𝙽 3\n`;
          const second = `🔴🟠🟡 𝙱𝙾𝚃 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙸𝙽 2\n`;
          const third = `🔴🟠🟡 𝙱𝙾𝚃 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙸𝙽 1\n`;
          const fourth = `🔴🟠🟡 𝙲𝚘𝚗𝚗𝚎𝚌𝚝𝚎𝚍 𝚜𝚞𝚌𝚎𝚜𝚜𝚏𝚞𝚕𝚕𝚢!\n\n𝚃𝚢𝚙𝚎 "${global.deku.PREFIX}help" 𝚝𝚘 𝚟𝚒𝚎𝚠 𝚊𝚕𝚕 𝚊𝚟𝚊𝚒𝚕𝚊𝚋𝚕𝚎 𝚌𝚘𝚖𝚖𝚊𝚗𝚍𝚜.\n𝚈𝚘𝚞 𝚌𝚊𝚗 𝚞𝚗𝚜𝚎𝚗𝚝 𝚝𝚑𝚎 𝚖𝚎𝚜𝚜𝚊𝚐𝚎 𝚘𝚏 𝚋𝚘𝚝 𝚋𝚢 𝚛𝚎𝚊𝚌𝚝𝚒𝚗𝚐 𝚕𝚒𝚔𝚎 (👍) 𝚘𝚗 𝚒𝚝𝚜 𝚖𝚎𝚜𝚜𝚊𝚐𝚎`;
